// Based on https://github.com/DevExpress/DevExtreme.AspNet.Data.NgHttpClientSample/blob/master/src/ng-http-client-helper.ts
...
export function sendRequestFactory(httpClient: HttpClient) {
  ...
  function assignResponseProps(xhrSurrogate, response: HttpResponse<any> | HttpErrorResponse) {
